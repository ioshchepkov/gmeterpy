...
class ISA1975(Constant):
    ...
    _has_incompatible_units: ClassVar[set] = set()
...
L = ISA1975("L", "Temperature lapse rate.", 0.0065, "K / m", 0.0, system="si")
...
gn = ISA1975(
    "gn", "Standard acceleration of free-fall.", 9.80665, "m / s**2", 0.0, system="si"
)

M = ISA1975(
    "M", "Air molar mass at sea level.", 0.028964420, "kg / mol", 0.0, system="si"
)

R = ISA1975("R", "Universal gas constant.", 8.31432, "J / (mol * K)", 0.0, system="si")
